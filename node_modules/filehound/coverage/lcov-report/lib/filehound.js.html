...
<html lang="en">
<head>
    <title>Code coverage report for lib/filehound.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> filehound.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.32% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>166/176</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i &lt; props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; <span class="missing-if-branch" title="else path not taken" >E</span>if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (<span class="missing-if-branch" title="else path not taken" >E</span>protoProps) defineProperties(Constructor.prototype, protoProps); <span class="missing-if-branch" title="else path not taken" >E</span>if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
&nbsp;
...
&nbsp;
function _interopRequireWildcard(obj) { if (<span class="missing-if-branch" title="else path not taken" >E</span>obj &amp;&amp; obj.__esModule) { return obj; } else { var <span class="cstat-no" title="statement not covered" >newObj = {}; <span class="cstat-no" title="statement not covered" >i</span>f (obj != null) { for (<span class="cstat-no" title="statement not covered" >var key in obj) { if (<span class="cstat-no" title="statement not covered" >Object.prototype.hasOwnProperty.call(obj, key)) <span class="cstat-no" title="statement not covered" >newObj[key] = obj[key]; } } <span class="cstat-no" title="statement not covered" >n</span>ewObj.default = obj; <span class="cstat-no" title="statement not covered" >r</span>eturn newObj; } }</span></span></span></span>
&nbsp;
...
&nbsp;
function _classCallCheck(instance, Constructor) { if (<span class="missing-if-branch" title="if path not taken" >I</span>!(instance instanceof Constructor)) { throw <span class="cstat-no" title="statement not covered" >new TypeError("Cannot call a class as a function"); } }</span>
&nbsp;
function _possibleConstructorReturn(self, call) { if (<span class="missing-if-branch" title="if path not taken" >I</span>!self) { throw <span class="cstat-no" title="statement not covered" >new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return c</span></span>all &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >t</span>ypeof call === "object" || <span class="branch-2 cbranch-no" title="branch not covered" >typeof call === "function") ? <span class="branch-0 cbranch-no" title="branch not covered" >call : self; }</span>
&nbsp;
function _inherits(subClass, superClass) { i</span>f (<span class="missing-if-branch" title="if path not taken" >I</span>typeof superClass !== "function" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >superClass !== null) { throw <span class="cstat-no" title="statement not covered" >new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass &amp;&amp; superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); <span class="missing-if-branch" title="else path not taken" >E</span>if (superClass) O</span>bject.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : <span class="branch-1 cbranch-no" title="branch not covered" >subClass.__proto__ = superClass; }</span>
&nbsp;
...
&nbsp;
    var _this = _possibleConstructorReturn(this, (</span>FileHound.__proto__ || <span class="branch-1 cbranch-no" title="branch not covered" >Object.getPrototypeOf(FileHound)).call(this));
&nbsp;
    _this._filters = [];
    _this._searchPaths = [];
...
&nbsp;
    ...
    value: function paths() {
      this._searchPaths = _lodash2.default.uniq(arrays.from(arguments)).map(_path2.default.normalize);
      return this;
    }
&nbsp;
    /**
...
&nbsp;
    ...
    value: function discard(pattern) {
      this.addFilter((0, _functions.negate)(isRegExpMatch(pattern)));
      return this;
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'ext',
    value: function ext() {
      var extensions = arrays.from(arguments);
&nbsp;
      this.addFilter(function (file) {
...
&nbsp;
      return pending.then(function (files) {
        if (_this3._directoriesOnly) return trackedPaths.filter(_this3._isMatch);
&nbsp;
        files.forEach(function (file) {
          _this3.emit('match', file.getName());
        });
        return files;
      });
    }
...
&nbsp;
      ...
      return getFiles().map(function (file) {
        if (file.isDirectorySync()) {
          if (!_this4._shouldFilterDirectory(root, file)) trackedPaths.push(file);
&nbsp;
          return _this4._search(root, file, trackedPaths);
        }
        return file;
    ...
    value: function getSearchPaths() {
      var paths = isDefined(this.maxDepth) ? this._searchPaths : files.reducePaths(this._searchPaths);
&nbsp;
...
&nbsp;
module.exports = FileHound;</pre></td></tr>
</table></pre>
<div class='push'></div><!-- for sticky footer -->
</div><!-- /wrapper -->
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Mar 10 2017 18:36:57 GMT+0000 (GMT)
</div>
</div>
