...
<html lang="en">
<head>
    <title>Code coverage report for lib/functions.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> functions.js
    </h1>
    <div class='clearfix'>
...
function compose(args) {
  var functions = _</span>lodash2.default.isFunction(args) ? <span class="branch-0 cbranch-no" title="branch not covered" >Array.from(arguments) : args;
&nbsp;
