...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> files.js
    </h1>
    <div class='clearfix'>
...
function getRoot(dir) {
  return _</span>os2.default.platform() === 'win32' ? <span class="branch-0 cbranch-no" title="branch not covered" >dir.split(_path2.default.sep)[0] + _path2.default.sep : _path2.default.sep;
}
&nbsp;
