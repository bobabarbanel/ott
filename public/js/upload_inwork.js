    ...
    function paintPage(machineSpecs, toolData) {
        ...
        function doRows(specs, turret, spindle, table, haves) {
            ...
            for (var t = lowT, s = lowS; t <= highT; t++ , s++) {
                let link = [turret,t,spindle,s].join("_");
                let trClass = "spaced";
        ...
        $('.fileUpload').on('change', function () {
            ...
            if (files.length > 0) {
                ...
                formData.append("turret", idFields[0]);
                formData.append("spindle", idFields[2]);
