...
//const EDGE = '<a class="edge">|</a>'; // appears between tabs names in navbar menu
...
class Util {
    ...
    static setUpTabs(key4id, here) {
        ...
        return new Promise((resolve, reject) => {
            Util.getTabsData(key4id).then(
                (data) => {
                    $('.navDropDownButton').html('<i class="fas fa-bars" style="margin-top:10px; border:1px solid white; padding: 10%">');
                    ...
                    if (here === "Main") {
                        ...
                        navDropDown.append($('<a class="tabaccess" href="/tabs/main.html">Main</a>'));
                    }
                    ...
                    if (here === "Tools") {
                        ...
                        navDropDown.append($('<a class="tabaccess" href="/tabs/tools.html">Tools</a>'));
                    }
                    topnav.append(nextTab);
    ...
    static definePageTab(num, tab, useTarget) {
        if (useTarget) {
            return $(`<a class="tabaccess" href="/showtab/${num}/${tab.tabName}"><span>${tab.tabName}</span></a>`);
        } else {
