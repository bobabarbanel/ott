...
$(function () {
    ...
    function paintPage(machineSpecs, toolData) {
        ...
        $(".fileupload").on("change", function () {
            ...
            if ($(this)[0].files !== undefined) {
                ...
                let fl = files.length;
                debugLog("change files " + JSON.stringify(files));
                ...
                fnameList.forEach((fileName) => {
                    ...
                    debugLog("\n\n**********\ncalling doCopy1\t" + fileName);
                    // should be synchronus
                    doCopy1(fileName, func, type, idFields[1], idFields[2])
                        .then(
                        (result) => {
        ...
        function doRows(specs, turret, spindle, table, haves) {
            ...
            for (var t = lowT, s = lowS; t <= highT; t++ , s++) {
                ...
                /*
                <form>
    <input id="I1" class="upload-input" type="file" name="uploads[]" multiple="multiple">
  ...
  */
        ...
        function doCopy1(fileName, func, type, position, offset) {
            debugLog("doCopy1 files ajax " + fileName);
